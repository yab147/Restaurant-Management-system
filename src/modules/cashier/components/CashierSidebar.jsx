...
const CashierSidebar = () => {
  const { currentUser, logout, sidebarOpen, setSidebarOpen, orders, payments } = useApp();
  ...
  const visibleNav = navItems.filter(item => item.roles.includes('cashier'));
  const roleColor = '#DC2626';
